// dataService.ts - Service layer for API integration
...
export const updateRom = async (rom: Rom): Promise<Rom> => {
  // The API doesn't support updating individual ROMs directly
  // This would need to be implemented in the API
  console.error('updateRom not implemented in API');
  throw new Error('updateRom not implemented in API');
};

export const deleteRom = async (id: number): Promise<boolean> => {
  // The API doesn't support deleting individual ROMs directly
  // This would need to be implemented in the API
  console.error('deleteRom not implemented in API');
  return false;
};
